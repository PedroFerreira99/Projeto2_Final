 ...
 */
public class ConsultarClientesFuncionarioController implements Initializable {
   ...
   //        
    ...
    //    }else if(f.getTipofuncionario().getIdTipofuncionario().intValue() == 2){
          FXRouter.when("EditarClienteFuncionario", "EditarClienteFuncionario.fxml");     
          FXRouter.goTo("EditarClienteFuncionario", c);
     //   }
